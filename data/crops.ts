...
const legacyDetailedCrops: Crop[] = [
  {
    ...
    seedRate: "नर्सरी बीज: 80–100 ग्राम/एकड़",
    spacing: "75 × 45 cm",
  ...
  },
  {
    ...
    seedRate: "हाइब्रिड रोपाई: 4–6 किलो/एकड़",
    spacing: "20 × 15 cm",
    suitableSeason: "खरीफ",
  ...
  },
  {
    ...
    seedRate: "हाइब्रिड: 7–8 किलो/एकड़",
    spacing: "60 × 20 cm",
  ...
  },
  {
    ...
    seedRate: "नर्सरी: 150–200 ग्राम/एकड़",
    spacing: "60 × 45 cm",
    suitableSeason: "रबी और वसंत",
  ...
  },
  {
    ...
    seedRate: "नर्सरी: 200–250 ग्राम/एकड़",
    spacing: "60 × 45 cm",
    suitableSeason: "रबी",
  ...
  },
  {
    ...
    seedRate: "हाइब्रिड: 400–500 ग्राम/एकड़",
    spacing: "150 × 50 cm",
  ...
  },
  {
    ...
    seedRate: "सेट: 25–30 क्विंटल/एकड़",
    spacing: "90 × 45 cm",
  ...
  },
  {
    ...
    estimatedYield: "180-250 क्विंटल प्रति एकड़",
    seedRate: "बीज कंद: 8–10 क्विंटल/एकड़",
    spacing: "60 × 20 cm",
    suitableSeason: "रबी",
  ...
  },
  {
    ...
    durationDays: "70-90 दिन",
    estimatedYield: "10-15 क्विंटल प्रति एकड़",
    seedRate: "हाइब्रिड: 1.5–2 किलो/एकड़",
    spacing: "45 × 10 cm",
    suitableSeason: "खरीफ",
  ...
  },
  {
    ...
    estimatedYield: "18-25 क्विंटल प्रति एकड़",
    seedRate: "समय पर: 40–45 किलो/एकड़",
    spacing: "22.5 × 5 cm",
    suitableSeason: "रबी",
  ...
  },
  {
    ...
    overview:
      "रबी भंडारण और खरीफ प्याज — उथली सिंचाई, गंधक-संतुलित पोषण, थ्रिप्स और बैंगनी धब्बा नियंत्रण से अच्छी बल्ब गुणवत्ता।",
    durationDays: "110-130 दिन",
    estimatedYield: "100-150 क्विंटल प्रति एकड़",
    seedRate: "नर्सरी: 4–5 किलो/एकड़",
    spacing: "15 × 10 cm",
    suitableSeason: "रबी (मुख्य) और खरीफ",
    suitableSoil: "अच्छी जल निकासी वाली हल्की दोमट",
    climate: "ठंडा-मध्यम; पाला और जलभराव से बचें",
    sowingGuide: {
      bestSowingTime: "नर्सरी अक्टूबर-नवंबर; रोपाई 6–7 सप्ताह बाद",
      seedRate: "नर्सरी: 4–5 किलो/एकड़",
      seedTreatment: "फफूंदनाशक / Trichoderma से बीज उपचार",
      spacing: "15 × 10 cm",
      sowingMethod: "नर्सरी पौध मेड़ पर रोपें",
    },
    fertilizerSchedule: {
      basalDose: ["Compost 8-10 t/acre", "DAP 50 kg/acre", "Sulphur 8-10 kg/acre"],
      stageWise: [
        { stage: "DAT 20–40", details: ["N टॉप-ड्रेस (urea विभाजन)"] },
        { stage: "बल्ब विकास", details: ["K शेष + कम N"] },
      ],
      micronutrients: ["Sulphur", "Zinc sulfate", "Boron foliar"],
      foliarSpray: ["Zn/B बल्ब-आरंभ पर लेबल अनुसार"],
    },
    irrigationManagement: {
      waterRequirement: "बार-बार हल्की सिंचाई; ड्रिप बेहतर",
      criticalStages: ["रोपाई", "बल्ब आरंभ", "बल्ब विकास"],
      schedule: ["असमान नमी से जुड़वाँ/फटा बल्ब", "कटाई से 10–15 दिन पहले पानी बंद"],
    },
    cropProtection: {
      majorPests: ["Thrips", "Onion maggot"],
      majorDiseases: ["Purple blotch", "Stemphylium", "Basal rot"],
      weedManagement: ["शुरुआत 45 दिन साफ खेत", "Pendimethalin पूर्व-उद्भव"],
      symptoms: ["चाँदी जैसी खरोंच", "बैंगनी धब्बा", "गर्दन मोटी"],
      prevention: ["स्वस्थ पौध", "फसल चक्र", "अत्यधिक देर N न दें"],
      control: ["थ्रिप्स MoA रोटेशन + sticker", "अनुशंसित फफूंदनाशक"],
    },
    nutrientDeficiencies: [
      { nutrient: "Sulphur", symptoms: "हल्की पत्तियाँ / कम तीखापन", cause: "S कम", solution: "Gypsum या bentonite S" },
      { nutrient: "Nitrogen", symptoms: "पीलापन, कम वृद्धि", cause: "N कम", solution: "urea विभाजन — देर में अधिक न दें" },
      { nutrient: "Potassium", symptoms: "कमजोर बल्ब", cause: "K कम", solution: "MOP बल्ब-अवस्था" },
    ],
    harvestAndYield: {
      harvestingTime: "neck-fall पर (रोपाई के ~100–120 दिन)",
      maturitySigns: ["पत्तियाँ गिरना", "गर्दन नरम"],
      yield: "100-150 q/acre",
      storageTips: ["अच्छी तरह curing/सुखाना", "ठंडी सूखी जगह"],
    },
    marketInformation: {
      majorMarkets: ["Lasalgaon", "Nashik", "Local mandi"],
      demand: "घरेलू खपत व भंडारण व्यापार",
      msp: "कोई निश्चित MSP नहीं",
  ...
  },
  {
    ...
    overview:
      "Bt संकर नकदी फसल — पहले 70 दिन खरपतवार-मुक्त, squaring/boll पर सिंचाई, PBW और सफ़ेद मक्खी के लिए IRAC रोटेशन ज़रूरी। Non-Bt refuge अनिवार्य।",
    durationDays: "150-180 दिन",
    estimatedYield: "8-12 क्विंटल लिंट प्रति एकड़",
    seedRate: "बीटी हाइब्रिड: 450–600 ग्राम/एकड़",
    spacing: "90 × 60 cm",
    suitableSeason: "खरीफ",
    suitableSoil: "गहरी जलोढ़ से काली चिकनी; जल निकासी अच्छी",
    climate: "अर्ध-शुष्क; 21–27°C वानस्पतिक अनुकूल",
    sowingGuide: {
      bestSowingTime: "उत्तर सिंचित मार्च–मई; वर्षा आधारित जून–जुलाई",
      seedRate: "बीटी हाइब्रिड: 450–600 ग्राम/एकड़",
      seedTreatment: "Imidacloprid WS + fungicide (लेबल)",
      spacing: "90 × 60 cm",
      sowingMethod: "क्यारी-नाली या सीधी बुवाई + non-Bt refuge",
    },
    fertilizerSchedule: {
      basalDose: ["DAP 40-50 kg/acre", "MOP 20-25 kg/acre"],
      stageWise: [
        { stage: "DAS 30", details: ["N भाग 1"] },
        { stage: "Squaring / flowering", details: ["N भाग + K"] },
      ],
      micronutrients: ["ZnSO₄", "Boron foliar", "MgSO₄ अगर reddening"],
      foliarSpray: ["फूल पर सूक्ष्म पोषक लेबल अनुसार"],
    },
    irrigationManagement: {
      waterRequirement: "700–1200 mm कुल; फूल-गांठ पर चरम",
      criticalStages: ["स्थापना", "स्क्वेयरिंग", "बॉल विकास"],
      schedule: ["जलभराव न करें", "चुनाई पर पानी घटाएँ"],
    },
    cropProtection: {
      majorPests: ["Pink bollworm", "Whitefly", "Jassid", "Thrips"],
      majorDiseases: ["CLCuV (leaf curl)", "Root rot"],
      weedManagement: ["0–70 DAS खरपतवार मुक्त", "Pendimethalin PPI"],
      symptoms: ["rosette फूल", "पत्ती मुड़ना", "square झड़ना"],
      prevention: ["Bt + refuge", "अवशेष नष्ट", "सिंथेटिक पाइरेथ्रॉइड सफ़ेद मक्खी पर बचें"],
      control: ["IRAC रोटेशन", "फेरोमोन ट्रैप", "लेबल खुराक"],
    },
    nutrientDeficiencies: [
      { nutrient: "Nitrogen", symptoms: "हल्की पत्तियाँ", cause: "N कम", solution: "N विभाजन — अधिक vegetative से बचें" },
      { nutrient: "Potassium", symptoms: "पत्ती किनारा जलना", cause: "K कम", solution: "MOP boll-अवस्था" },
      { nutrient: "Zinc", symptoms: "छोटी पत्तियाँ", cause: "Zn कम", solution: "ZnSO₄ मिट्टी/पर्ण" },
    ],
    harvestAndYield: {
      harvestingTime: "बॉल खुलने पर 3–4 चुनाई",
      maturitySigns: ["बॉल खुला", "लिंट साफ"],
      yield: "8-12 q lint/acre",
      storageTips: ["सूखी साफ कपास", "मिल/मंडी जल्दी"],
    },
    marketInformation: {
      majorMarkets: ["Cotton Corporation", "Ginning mills", "APMC"],
      demand: "मिल और निर्यात माँग",
      msp: "वर्तमान MSP / CCI देखें",
      priceTrend: "गुणवत्ता और अंतरराष्ट्रीय भाव से जुड़ा",
    },
  },
];
