...
export const FERTILIZER_RECOMMENDATIONS: FertilizerRecommendation[] = [
  ...
  },
  {
    ...
    source: "ICAR chickpea PoP",
    n: 20,
    p2o5: 40,
    k2o: 20,
    micronutrients: ["Rhizobium + PSB", "S 20 kg/ha if deficient", "ZnSO₄ if deficient"],
    splits: ["पूरी बेसल"],
    notes: ["अधिक सिंचाई wilt बढ़ाती है", "काबुली vs देशी seed rate अलग"],
  },
  {
    cropSlug: "masoor",
    cropName: "Masoor / Lentil",
    source: "ICAR lentil PoP",
    n: 20,
    p2o5: 40,
    k2o: 20,
    micronutrients: ["Rhizobium + PSB", "Zn if deficient"],
    splits: ["पूरी बेसल"],
    notes: ["हल्की मिट्टी बेहतर", "1–2 सिंचाई अक्सर पर्याप्त"],
  },
  {
    cropSlug: "urad",
    cropName: "Urad / Black gram",
    source: "ICAR blackgram PoP",
    n: 20,
    p2o5: 40,
    k2o: 20,
    micronutrients: ["Rhizobium + PSB", "Fe foliar on calcareous soils"],
    splits: ["पूरी बेसल"],
    notes: ["YMV दबाव क्षेत्र में प्रतिरोधी किस्म", "जलभराव निकालें"],
  },
  {
    cropSlug: "ginger",
    cropName: "Ginger",
    source: "ICAR / spice PoP",
    n: 75,
    p2o5: 50,
    k2o: 100,
    micronutrients: ["FYM 25–30 t/ha", "Zn/B as soil test"],
    splits: ["बेसल + 45–60 DAP + 90–120 DAP"],
    notes: ["K अधिक जरूरत", "जल निकासी rhizome rot रोकती है"],
  },
  {
    cropSlug: "garlic",
    cropName: "Garlic",
    source: "ICAR / onion-garlic PoP",
    n: 60,
    p2o5: 50,
    k2o: 50,
    micronutrients: ["Sulphur 20–25 kg/ha", "Zn/B foliar if needed"],
    splits: ["बेसल + 30–40 DAP N"],
    notes: ["S गुणवत्ता के लिए जरूरी", "कटाई से पहले पानी बंद"],
  },
  {
    cropSlug: "mango",
    cropName: "Mango",
    source: "ICAR fruit PoP (age-based)",
    n: 50,
    p2o5: 25,
    k2o: 50,
    micronutrients: ["Zn", "B", "Fe — soil/leaf test"],
    splits: ["मानसून + फूल/फल अवस्था"],
    notes: ["उम्र अनुसार मात्रा बढ़ाएँ", "नया बाग में कम N"],
  },
  {
    cropSlug: "banana",
    cropName: "Banana",
    source: "ICAR banana PoP",
    n: 200,
    p2o5: 60,
    k2o: 300,
    micronutrients: ["Zn", "B", "Mg", "S"],
    splits: ["मासिक/ड्रिप विभाजन — K भारी"],
    notes: ["K बहुत जरूरी", "ड्रिप fertigation बेहतर"],
  },
  {
    cropSlug: "grapes",
    cropName: "Grapes",
    source: "ICAR / Maharashtra grape PoP",
    n: 100,
    p2o5: 50,
    k2o: 150,
    micronutrients: ["Zn", "B", "Mg", "Fe", "Ca"],
    splits: ["छंटाई के बाद + फूल/गुच्छा"],
    notes: ["मिट्टी जाँच अनिवार्य", "अधिक N रोग बढ़ाता है"],
  },
];
