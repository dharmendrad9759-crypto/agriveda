...
export const cropPestDiseaseData: Record<string, CropPestDiseaseData> = {
  paddy: {
    ...
    pests: [
      { id: "p1", name: "Brown Planthopper", scientificName: "Nilaparvata lugens", image: IMG3, stage: "Tillering–heading", iracGroup: "IRAC 16", control: "Carbofuran granules / Buprofezin spray at ETL" },
      { id: "p2", name: "Stem Borer", scientificName: "Scirpophaga incertulas", image: IMG, stage: "Vegetative", iracGroup: "IRAC 14", control: "Cartap hydrochloride or Chlorantraniliprole" },
      { id: "p3", name: "Army Worm", scientificName: "Spodoptera frugiperda", image: IMG3, stage: "Tillering", iracGroup: "IRAC 28", control: "Emamectin benzoate at early infestation" },
      { id: "p4", name: "Leaf Folder", scientificName: "Cnaphalocrocis medinalis", image: IMG, stage: "Panicle initiation", iracGroup: "IRAC 18", control: "Flubendiamide or Trichogramma release" },
    ],
    diseases: [
      { id: "d1", name: "Blast", pathogen: "Magnaporthe oryzae", image: IMG2, stage: "Tillering", fracGroup: "FRAC 3", control: "Tricyclazole / Azoxystrobin spray" },
      { id: "d2", name: "Sheath Blight", pathogen: "Rhizoctonia solani", image: IMG, stage: "Panicle initiation", fracGroup: "FRAC 32", control: "Validamycin or Hexaconazole" },
      { id: "d3", name: "Bacterial Leaf Blight", pathogen: "Xanthomonas oryzae", image: IMG2, stage: "Max tillering", fracGroup: "—", control: "Streptocycline + Copper oxychloride" },
    ],
    weeds: [
      { id: "w1", name: "Barnyard Grass", scientificName: "Echinochloa crus-galli", type: "Grassy", criticalPeriod: "0–45 DAS", preEmergence: "Pretilachlor 50 EC @ 0.6 kg/ha", postEmergence: "Bispyribac sodium @ 25 g/ha", culturalControl: "Stale seedbed, puddling before transplant" },
      { id: "w2", name: "Flat Sedge", scientificName: "Cyperus iria", type: "Sedge", criticalPeriod: "15–60 DAS", preEmergence: "Pretilachlor + Pyrazosulfuron", postEmergence: "Bispyribac sodium", culturalControl: "Maintain 5 cm standing water" },
      { id: "w3", name: "Alligator Weed", scientificName: "Alternanthera philoxeroides", type: "Broadleaf", criticalPeriod: "20–50 DAS", preEmergence: "Pretilachlor", postEmergence: "2,4-D Na salt (direct-seeded only)", culturalControl: "Hand weeding at 20 & 40 DAS" },
    ],
  },
  wheat: {
  ...
  chilli: {
    ...
    pests: [
      { id: "p1", name: "Fruit Borer", scientificName: "Helicoverpa armigera", image: IMG3, stage: "Flowering–fruiting", iracGroup: "IRAC 28", control: "Emamectin benzoate / HaNPV" },
      { id: "p2", name: "Thrips", scientificName: "Scirtothrips dorsalis", image: IMG3, stage: "Vegetative", iracGroup: "IRAC 4A", control: "Fipronil / Diafenthiuron" },
      { id: "p3", name: "Mites", scientificName: "Polyphagotarsonemus latus", image: IMG, stage: "Dry weather", iracGroup: "IRAC 6", control: "Propargite / Abamectin" },
    ],
    diseases: [
      { id: "d1", name: "Anthracnose", pathogen: "Colletotrichum capsici", image: IMG2, stage: "Fruiting", fracGroup: "FRAC M5", control: "Mancozeb + Carbendazim" },
      { id: "d2", name: "Die-back", pathogen: "Colletotrichum gloeosporioides", image: IMG, stage: "Any stage", fracGroup: "FRAC 3", control: "Copper oxychloride pruning + spray" },
      { id: "d3", name: "Leaf Curl Virus", pathogen: "Begomovirus (whitefly vector)", image: IMG2, stage: "Vegetative", fracGroup: "—", control: "Whitefly control, resistant varieties" },
    ],
    weeds: [
      { id: "w1", name: "Parthenium", scientificName: "Parthenium hysterophorus", type: "Broadleaf", criticalPeriod: "0–40 DAT", preEmergence: "Pendimethalin @ 1.0 kg/ha", postEmergence: "Hand weeding + mulching", culturalControl: "Raised beds with plastic mulch" },
      { id: "w2", name: "Trianthema", scientificName: "Trianthema portulacastrum", type: "Broadleaf", criticalPeriod: "10–35 DAT", preEmergence: "Pendimethalin", postEmergence: "Interculture", culturalControl: "Drip + mulching" },
      { id: "w3", name: "Digitaria", scientificName: "Digitaria sanguinalis", type: "Grassy", criticalPeriod: "0–25 DAT", preEmergence: "Pendimethalin", postEmergence: "Hand hoe between rows", culturalControl: "Stale seedbed" },
    ],
  },
  cotton: {
