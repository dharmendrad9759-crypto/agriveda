...
> = {
  ...
  calcium: {
    ...
    bachav: [
      "सिंचाई एक जैसी रखें",
      "फल पर कैल्शियम नाइट्रेट छिड़काव",
      "मूंगफली में फूल/pegging पर जिप्सम ~200 kg/एकड़ (राज्य PoP)",
    ],
  },
  magnesium: {
    nameHi: "मैग्नीशियम",
  ...
  iron: {
    ...
    bachav: [
      "मिट्टी/ऊतक परीक्षण के बाद ही Fe दर",
      "FeSO4 + सिट्रिक एसिड छिड़काव",
      "उच्च pH में Fe-EDDHA; ज़्यादा DAP न डालें",
    ],
  },
  zinc: {
    nameHi: "जिंक",
    ...
    bachav: [
      "Soil Health Card पर Zn कम हो तो ZnSO4 ~10 kg/एकड़ (≈25 kg/हे.)",
      "0.5% जिंक सल्फेट छिड़काव",
      "ज़्यादा DAP से बचें",
    ],
  },
  manganese: {
  ...
  copper: {
    ...
    bachav: ["कम मात्रा में कॉपर सल्फेट", "मिट्टी परीक्षण के बाद", "हर साल भारी मात्रा न डालें"],
  },
  molybdenum: {
    nameHi: "मॉलिब्डेनम",
    ...
    bachav: ["खट्टी मिट्टी में चूना", "मिट्टी परीक्षण के बाद ही Mo", "बहुत कम मात्रा (ग्राम स्तर)"],
  },
  silicon: {
    nameHi: "सिलिकॉन",
  ...
  cobalt: {
    ...
    bachav: ["Rhizobium बीज उपचार", "संतुलित खाद", "CoSO4 किसान स्प्रे न करें"],
  },
  nickel: {
    nameHi: "निकल",
    ...
    bachav: ["Ni खाद/स्प्रे न करें", "संदेह पर मिट्टी परीक्षण (प्रदूषण)"],
  },
};
