...
Write-Host "  - Privacy: $url/privacy"
Write-Host "  - Terms:    $url/terms"
Write-Host "  - Support:  support@agriveda.in (verify inbox!)"
Write-Host "  - Package:  com.agriveda.app"
Write-Host "  - Data Safety guide: docs/PLAY_STORE.md"
Write-Host "  - Feature graphic: public/play-listing/feature-graphic.png (1024x500)"
Write-Host "  - Phone screenshots: public/play-listing/screenshots/"
Write-Host "  - High-res icon: public/play-listing/high-res-icon-512.png"
Write-Host "  - In-app delete: Settings → खाता हटाएँ"
Write-Host "  - Firebase: add Play App Signing SHA-1 (and SHA-256) under Android app"
Write-Host "  - Bump versionCode before each upload"
Write-Host ""
Write-Host "Capacitor must point at HTTPS (this script set CAPACITOR_SERVER_URL)." -ForegroundColor Yellow
Write-Host "Do NOT upload an AAB synced without -ProductionUrl — WebView would load the stub shell."
